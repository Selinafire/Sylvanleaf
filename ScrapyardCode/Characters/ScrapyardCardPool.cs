...
#pragma warning restore CS0618
    ...
    public override string Title => "Scrapyard";
    public override string EnergyColorName => "Scrapyard";

    // 这里指定卡牌文本和大图使用的能量图标路径。
    // res://Scrapyard/... 里的 Scrapyard 是 PCK 资源目录，不是 C# namespace。
    ...
    public override Color DeckEntryCardColor => ScrapyardCharacter.ThemeColor;
